...
class LocationStudentController extends GetxController{
  ...
  void onInit() {
    ...
    initialCameraPosition =const CameraPosition(target: LatLng(17.48517166646448, 47.11383251333239),zoom: 10);
    super.onInit();
