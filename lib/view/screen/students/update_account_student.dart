...
import '../../../controller/student/update_account_student.dart';
import '../../widget/global/custom_icon_appbar.dart';
class UpdateAccountStudentScreen extends StatelessWidget {
  UpdateAccountStudentScreen({super.key});
  final controller =Get.put(UpdateAccountStudentController());
  @override
          ...
          children: [
            ...
            Container(
              ...
              child: ListTile(
                ...
                subtitle: CustomText(text: sharedPreferences.getString(Global.studentEmail.toString())??"",
            ...
            const SizedBox(height: 32,),
            GetBuilder<UpdateAccountStudentController>(builder: (controller)=>
