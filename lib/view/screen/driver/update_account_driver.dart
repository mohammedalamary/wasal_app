...
import '../../../controller/driver/update_account_driver.dart';
import '../../widget/global/custom_icon_appbar.dart';
class UpdateAccountDriverScreen extends StatelessWidget {
  UpdateAccountDriverScreen({super.key});
  final controller =Get.put(UpdateAccountDriverController());
  @override
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 32,),
            GetBuilder<UpdateAccountDriverController>(builder: (controller)=>
