...
class AddNotificationSchool extends StatelessWidget {
   AddNotificationSchool({super.key});
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            GetBuilder<AddNotificationSchoolController>(builder: (controller)=>HandlingDataRequest(
